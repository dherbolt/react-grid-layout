  ...
  _createClass(ReactGridLayout, [{
    ...
    /*: ?ReactElement<any>*/
    {
      ...
      var _this$props5 = this.props,
          ...
          resizeAxisGlob = _this$props5.resizeAxis;
      ...
      var resizable = typeof l.isResizable === "boolean" ? l.isResizable && l.resizeAxis !== "none" && resizeAxisGlob !== "none" : !l.static && isResizable && resizeAxisGlob !== "none" && l.resizeAxis !== "none";
      var resizeAxis = resizable ? l.resizeAxis || resizeAxisGlob : "none";
      return _react.default.createElement(_GridItem.default, {
        containerWidth: width,
        cols: cols,
        margin: margin,
...
_defineProperty(ReactGridLayout, "propTypes", {
  ...
  resizeAxis: _propTypes.default.oneOf(["both", "x", "y", "none"]),
